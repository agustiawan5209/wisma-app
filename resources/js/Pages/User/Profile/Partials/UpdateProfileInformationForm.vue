...
const form = useForm({
    ...
    alamat: props.user.detail.alamat,
    no_hp: props.user.detail.no_hp,
    jenkel: props.user.detail.jenkel,
    foto: props.user.detail.foto,
});

console.log(props.user.detail)
const UrlFile = ref(props.user.detail.profile_path);
    ...
    <section>
        ...
        <form @submit.prevent="form.post(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div class="col-span-2">
                <input id="dropzone-file" type="file" @input="fileSelected($event)"/>

                <img class=" w-32 rounded-full" :src="UrlFile" alt="">
