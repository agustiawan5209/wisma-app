                ...
                <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden px-4">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in voucher.data" class="border-b ">
                                    <th class="border text-center">{{ (voucher.current_page - 1) * voucher.per_page + index + 1
                                    }}.</th>
                    ...
                    <Pagination :links="voucher.links" />
                </div>
            </section>
